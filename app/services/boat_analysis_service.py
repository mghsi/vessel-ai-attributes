...
class BoatAnalysisService:
    ...
    def __init__(self, github_pat: str, api_url: str, model: str = 'openai/gpt-4o'):
    ...
    def analyze_boat(self, image_base64: str, boat_brand: str, boat_model: str) -> Dict[str, Any]:
...
"""
    ...
    def _parse_model_response(self, response: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            required_fields = ['Boat Type', 'Length', 'Width', 'Beam', 'Aux', 'Commercial']
