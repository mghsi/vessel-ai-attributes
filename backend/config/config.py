...
class Config:
    ...
    UPLOAD_FOLDER = os.environ.get("UPLOAD_FOLDER") or os.path.join(Path(__file__).parent.parent, "uploads")
    ...
    GITHUB_API_URL = os.environ.get("GITHUB_API_URL") or "https://models.inference.ai.azure.com/chat/completions"
